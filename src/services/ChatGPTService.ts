...
export class ChatGPTService {
  ...
  async summarizeForTelegram(content: string): Promise<string> {
    ...
    const userPrompt = `
      ...
      5. Убрать из результата все ссылки на источники и любые упоминания о создателях текста
      6. Вернуть текст в формате HTML. Если в исходном тексте есть изображения, то сохрание его в результате. Используй только теги <h1-6>, <p>, <b>, <i>, <em>, <strong>, <img>.
